...
DOWNLOAD_URL = 'https://raw.githubusercontent.com/wozaiha/DalamudPlugins/CustomRepo/plugins/{plugin_name}/{plugin_name}.zip'
...
def last_updated():
    ...
    for plugin in master:
        latest = 'plugins/{plugin["InternalName"]}/{plugin["InternalName"]}.zip'

...
| No Kill Plugin | Bluefissure | A simple plugin that prevent the game from killing itself. |
...
| Glamaholic | ascclemens | Create and save as many glamour plates as you want. Activate up to 15 of them<br>at once at the Glamour Dresser. Supports exporting and importing plates for<br>easy sharing.<br> |
...
| Sonar | Sonar Team | Automatically send and receive hunt and fate relays. /sonar to open, /sonarconfig to configure. This plugin is closed source and support is only provided in the Sonar Support discord. |

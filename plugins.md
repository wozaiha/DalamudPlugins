...
| attick | Mouseover Action | 该插件允许类似宏的操作使用，而没有任何宏延迟。/pmoaction 打开设置 |
...
| Caraxi, LittleNightmaare, Tsubasahane | Simple Tweaks | 改善游戏体验小工具集合。 旨在改善体验，而无需进行大幅度更改。<br>所有更改都是可切换的，默认情况下禁用所有功能。 访问代码仓库以获取完整的调整列表。 （下面的地球图标） |
| Haplo064 | SlideCast | 添加指示符，指示何时可以安全滑步。 |
| karashiiro | SoundSetter | 一个Dalamud插件，允许从任何地方进行音量控制，包括调音和过场动画。 |
| - | StarlightBreaker | Turn off profanity filter. |
| Pohky | Teleporter | 传送到水晶的聊天命令。 /tp 寻求帮助 |
| attick & perchbird | TitleEdit | Create, share, and shuffle custom title screens for FFXIV. |
| ascclemens | Tourist | Tourist 会添加一个窗口来辅助观光日志。<br><br>-在有观光日志视景时显示<br>-在ARR视景中添加标记<br>-在地图上打开视景位置<br>-隐藏已完成或不可用的视景<br>-显示每个远景所需的命令 |
